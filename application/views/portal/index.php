...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .app-card:hover .app-open-link { opacity: 1; }
    ...
    .toast-custom.success { border-left: 3px solid var(--accent-green); }
    .toast-custom.error   { border-left: 3px solid var(--accent-red);   }
    ...
    @media (max-width: 1400px) {
      .apps-grid { grid-template-columns: repeat(4, 1fr); gap: 24px; }
    }
    ...
    @media (max-width: 576px) {
      ...
      .app-logo-wrap { width: 80px; height: 80px; }
      .app-logo-initials { font-size: 1.5rem; }
    }
  </style>
</head>
<body>
  ...
  <div class="container-xl">
    <div class="d-flex align-items-center justify-content-start flex-wrap gap-3">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <?php $active_count = count(array_filter($apps, fn($a) => $a->is_active)); ?>
        <span class="stat-pill">
